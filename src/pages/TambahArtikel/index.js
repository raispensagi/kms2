...
const TambahArtikel = ({navigation}) => {
    ...
    const simpan = async (screen) => {
        ...
        fetch(`http://117.53.47.76:8001/api/artikel/draft `,
        {
            method:"POST",
            headers: new Headers ( {
    ...
    const bagikan = async (screen) => {
        ...
        if (form.judul!=='' && form.isi!=='' && form.kategori!=='') {
        fetch(`http://117.53.47.76:8001/api/artikel/post`,
        {
            method:"POST",
            headers: new Headers ( {
                Authorization : 'Bearer ' + userToken,
    ...
    return(
        <ScrollView style={{flex:1}}>
            ...
            <Text style={styles.textbutton} >Tuliskan Kategori</Text>
            ...
            <Text style={styles.textbutton} >Tuliskan Isi Artikel</Text>
